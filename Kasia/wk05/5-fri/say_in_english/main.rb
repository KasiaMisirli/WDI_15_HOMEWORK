...
if number.digits.count == 1
    ...
    tw = {20=>"twenty",30=>"thirty",40=>"forty",50=>"fifty",60=>"sixty",70=>"seventy",80=>"eighty",90=>"ninety",1=>"one",2=>"two",3=>"three",4=>"four",5=>"five",6=>"six",7=>"seven",8=>"eight",9=>"nine"}
    print tw[((arr.first)+"0").to_i] +"-"+ tw[arr.last.to_i]
end
